    ...
    <div className="row pb-2 text-end">
        <div className="col-3">
            <div className="row">
                ...
                <button id="tamaño-texto" className="btn btn-aumentar me-2" onClick={aumentarTexto}>
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-zoom-in ms-1" viewBox="0 0 16 16">
...
<button id="tamaño-texto" className="btn btn-disminuir" onClick={disminuirTexto}>
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-zoom-out ms-1" viewBox="0 0 16 16">
    <path fillRule="evenodd" d="M6.5 12a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11M13 6.5a6.5 6.5 0 1 1-13 0 6.5 6.5 0 0 1 13 0"/>
    <path d="M10.344 11.742q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1 6.5 6.5 0 0 1-1.398 1.4z"/>
