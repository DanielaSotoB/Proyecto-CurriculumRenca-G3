                ...
                <div className="col-md-4">
                  <div className="card mb-3">
                    <div className="card-body">
                      ...
                      <button className="btn btn-primary" onClick={() => redirectToPage('usuarios.html')}>Ir a Usuarios</button>
                    </div>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="card mb-3">
                    <div className="card-body">
                      ...
                      <button className="btn btn-primary" onClick={() => redirectToPage('cursos.html')}>Ir a Cursos</button>
                    </div>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="card mb-3">
                    <div className="card-body">
                      ...
                      <button className="btn btn-primary" onClick={() => redirectToPage('estadisticas.html')}>Ir a Estadísticas</button>
                    </div>
                  </div>
                </div>
              </div>
